/* mtree_am/mtree_am--1.0.sql */

-- complain if script is sourced in psql, rather than via CREATE EXTENSION
\echo Use "CREATE EXTENSION mtree_am2" to load this file. \quit
...
-- CREATE FUNCTION mtree_am_handler(internal)
-- RETURNS table_am_handler
-- AS 'MODULE_PATHNAME'
-- LANGUAGE C;

-- -- Access method
-- CREATE ACCESS METHOD mtree_am TYPE TABLE HANDLER mtree_am_handler;
-- COMMENT ON ACCESS METHOD mtree_am IS 'template table AM eating all data';

-- bind mtree index
CREATE FUNCTION mtreehandler(internal) RETURNS index_am_handler
...
CREATE OPERATOR CLASS vector_cosine_ops
	FOR TYPE vector USING mtree AS
